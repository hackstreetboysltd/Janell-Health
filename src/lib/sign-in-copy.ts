...
export const SIGN_IN_COPY = {
  patient: {
    ...
    googleHint: "Continue with Google to open the family portal.",
  },
  giver: {
    ...
    googleHint: "Continue with Google to open the caregiver portal.",
  },
  admin: {
    title: "Admin sign in",
    ...
    googleHint: "Continue with Google. Ops access still requires ADMIN in the database.",
  },
} as const satisfies Record<
  SignInPortal,
  { title: string; otpHint: string; demoHint: string; googleHint: string }
>;
